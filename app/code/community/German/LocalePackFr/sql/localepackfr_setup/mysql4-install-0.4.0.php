...
{{depend store_email}}par email <a href="mailto:{{var store_email}}">{{var store_email}}</a>,{{/depend}}
{{depend store_phone}}par téléphone au <a href="tel:{{var phone}}">{{var store_phone}}</a>,{{/depend}}
